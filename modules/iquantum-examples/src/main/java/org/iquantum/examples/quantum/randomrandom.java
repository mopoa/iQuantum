...
public class randomrandom {
    ...
    public static void main(String[] args) throws IOException {
        System.out.println("Start the iQuantum rr");
        ...
        String exampleName = "randomrandom";
...
//        // Step 8: Print the results when simulation is over
        ...
        Log.printLine("iQuantum rr finished!");
    }
    ...
    private static QDatacenterExtended createQDatacenter(String name) {
        ...
        QNodeMQ qNode3 = IBMQNodeMQ.createNode(2,"ibm_kolkata",new QTaskSchedulerFCFSMQ());
        QNodeMQ qNode4 = IBMQNodeMQ.createNode(3,"ibm_mumbai",new QTaskSchedulerFCFSMQ());
        QNodeMQ qNode5 = IBMQNodeMQ.createNode(4,"ibm_auckland",new QTaskSchedulerFCFSMQ());
        QNodeMQ qNode6 = IBMQNodeMQ.createNode(5,"ibm_geneva",new QTaskSchedulerFCFSMQ());
